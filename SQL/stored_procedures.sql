-- -------------------------------------------------------
-- Create Stored Procedures for engine_management
-- -------------------------------------------------------
...
FROM engine_management.engine_usage eu1
 ...
 select c.company_name,
        ...
        'Billing generated but not processed' as message
    ...
    where year = prm_year and month = prm_month
...
BEGIN
	...
	declare loc_rate decimal (5,2);
	declare loc_harsh_environment bit(1);
    declare loc_harsh_environment_loading decimal (10,2);
    declare loc_usage_charge decimal (10,2);    
    declare loc_harsh_environment_charge decimal (10,2);
    declare done bit(1);
